...
const Index = () => {
  ...
  return (
    <div>
      ...
      <p className='ml-4 text-blue-500 underline'><Link to={getUrl('products', '8')}>・ノイズ</Link></p>
      <p className='ml-4 text-blue-500 underline'><Link to={getUrl('products', '9')}>・蠢く球体</Link></p>
